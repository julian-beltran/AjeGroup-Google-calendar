            ...
            <form method="post" class="guardar_rol" id="guardar_rol">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="guardar_rol">Guardar registro</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-dialog">
            <form method="post" class="guardar_permiso" id="guardar_permiso">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-primary" id="guardar_permiso">Guardar registro</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-dialog">
            <form method="POST" action="{{ route('usuario.roles.update') }}" class="asignarPermisoAlRol" id="asignarPermisoAlRol">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-primary" id="asignar_permisos">Asignar Permisos</button>
                    </div>
                </div>
            </form>
        </div>
