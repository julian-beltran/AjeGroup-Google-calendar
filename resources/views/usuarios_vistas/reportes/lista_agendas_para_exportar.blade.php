                            ...
                            <form action="" class="p-4 rounded">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-3 col-sm-12 text-center mb-2">
                                        <button type="button" onclick="filtrarReportes()" class="btn btn-outline-light btn-block" id="buscar"><i class="fas fa-search mr-1"></i>Buscar</button>
                                    </div>
                                    <div class="col-md-3 col-sm-12 text-center mb-2">
                                        <button type="button" onclick="restablecerFiltro()" class="btn btn-outline-secondary btn-block" id="reset"><i class="fas fa-trash-alt mr-1"></i>Limpiar</button>
                                    </div>
                                    <div class="col-md-3 col-sm-12 text-center mb-2">
                                        <button type="button" class="btn btn-outline-success btn-block" id="exportExcel" onclick="exportarReportes()"><i class="far fa-file-excel mr-1"></i>Excel</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@section('js')
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.datatable_agendas_exportar').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d){
                        d.fecha_desde = $('#fecha_desde_input').val();
                        d.fecha_hasta = $('#fecha_hasta_input').val();
                        d.espacio = $('#espacio_input').val();
                        d.area = $('#area_input').val();
                    ...
                    success: function(data) {
                        ...
                        if (descargables.length > 0) {
                            $.each(descargables, function(index, descargable) {
                                $('#descargablesContainer').append(`<a href="${descargable.url}" target="_blank" download>${descargable.nombre}</a><br>`);
                            });
                        } else {
        ...
        function filtrarReportes(){
            $('.datatable_agendas_exportar').DataTable().ajax.reload();
        }
        ...
        // Funcion para exportar los reportes:
