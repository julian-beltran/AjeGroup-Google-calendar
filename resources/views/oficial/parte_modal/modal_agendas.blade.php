                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_max_10">
                                </div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_grupales" class="" style="height: 400px; overflow-y:scroll !important;">
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalPares" tabindex="-1" aria-labelledby="agendarEventoModalParesLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaPares" id="formAddAgendaPares">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalParesLabel">Agendar evento en: <span id="espacio_pares"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_pares"></div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_pares" style="height: 400px; overflow-y:scroll !important;"></div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalRanking" tabindex="-1" aria-labelledby="agendarEventoModalRankingLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaRanking" id="formAddAgendaRanking">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalRankingLabel">Agendar evento en: <span id="espacio_ranking"></span> | <span id="area_ranking"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_ranking"></div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_ranking" style="height: 400px; overflow-y:scroll !important;"></div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalRetroalimentacion" tabindex="-1" aria-labelledby="agendarEventoModalRetroalimentacionLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaRetroalimentacion" id="formAddAgendaRetroalimentacion">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalRetroalimentacionLabel">Agendar evento en: <span id="espacio_retroalimentacion"></span> | <span id="area_retroalimentacion"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_retroalimentacion"></div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_retroalimentacion" style="height: 400px; overflow-y:scroll !important;"></div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalCountry" tabindex="-1" aria-labelledby="agendarEventoModalCountryLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaCountry" id="formAddAgendaCountry">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalCountryLabel">Agendar evento en: <span id="espacio_country"></span> | <span id="area_country"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_country"></div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_country" style="height: 400px; overflow-y:scroll !important;"></div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalPrimario" tabindex="-1" aria-labelledby="agendarEventoModalPrimarioLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaPrimario" id="formAddAgendaPrimario">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalPrimarioLabel">Agendar evento en: <span id="espacio_primario"></span> | <span id="area_primario"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_primario"></div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_primario" style="height: 400px; overflow-y:scroll !important;"></div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalCompras" tabindex="-1" aria-labelledby="agendarEventoModalComprasLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaCompras" id="formAddAgendaCompras">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalComprasLabel">Agendar evento en: <span id="espacio_compras"></span> | <span id="area_compras"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_compras"> </div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_compras" style="height: 400px; overflow-y:scroll !important;"> </div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalMerco" tabindex="-1" aria-labelledby="agendarEventoModalMercoLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaMerco" id="formAddAgendaMerco">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalMercoLabel">Agendar evento en: <span id="espacio_merco"></span> | <span id="area_merco"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_merco"> </div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_merco" style="height: 400px; overflow-y:scroll !important;"> </div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalIndicadores" tabindex="-1" aria-labelledby="agendarEventoModalIndicadoresLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaIndicadores" id="formAddAgendaIndicadores">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalIndicadoresLabel">Agendar evento en: <span id="espacio_indicadores"></span> | <span id="area_indicadores"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                        ...
                        <div class="col">
                            <div class="row d-block">
                                <div class="row">
                                 ...
                                 <div class="row w-100" id="areas_del_usuario_logueado_indicadores"></div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_indicadores" style="height: 400px; overflow-y:scroll !important;"></div>
                            </div>
                        </div>
...
<div class="modal fade" id="agendarEventoModalSostenibilidad" tabindex="-1" aria-labelledby="agendarEventoModalSostenibilidadLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="formAddAgendaSostenibilidad" id="formAddAgendaSostenibilidad">
            ...
            <div class="modal-content">
                <div class="modal-header modal-header-agendar">
                    <h1 class="modal-title fs-5" id="agendarEventoModalSostenibilidadLabel">Agendar evento en: <span id="espacio_sostenibilidad"></span> | <span id="area_sostenibilidad"></span></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col">
                            <div class="row d-block">
                                ...
                                <div class="row w-100" id="areas_del_usuario_logueado_sostenibilidad"></div>
                            </div>
                            <div class="row">
                                <strong><i class="fas fa-users"></i> Invitados:  </strong> <br>
                                <div class="row d-block" id="lista_usuarios_sostenibilidad" style="height: 400px; overflow-y:scroll !important;"></div>
                            </div>
                        </div>
