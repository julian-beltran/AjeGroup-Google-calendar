                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 second-content-form">
                            <form action="" class="p-2 rounded">
                                ...
                                <div class="row text-center d-flex justify-content-center">
                                    <button type="button" class="btn btn-outline-light mr-2 col-3" id="buscar" onclick="filtrarAgendas()"><i class="fas fa-search mr-1"></i>Buscar</button>
                                    <button type="button" class="btn btn-outline-secondary col-3" id="reset" onclick="restablecerFiltro()"><i class="fas fa-trash-alt mr-1"></i>Limpiar</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function verEvidencias(id_agenda){
            $.ajax({
                url: '/admin/agenda/invitados/download/'+id_agenda,
                headers: {
