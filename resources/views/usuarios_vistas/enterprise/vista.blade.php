                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, row, meta){
                            return '<a href="javascript:void(0)" id="show" data-url="/admin/enterprise/edit_pais/' + row.id + '" class="btn btn-outline-success show-pais-modal-edit mb-1"><i style="font-size: 20px; font-weight: bold;" class="fas fa-pencil-alt"></i></a>'+
                ...
                columnDefs: [
                    {
                        targets: -1,
                        render: function(data, type, row, meta){
                            return '<a href="javascript:void(0)" id="show" data-url="/admin/enterprise/edit_corporativo/' + row.id + '" class="btn btn-outline-success show-corporativo-modal-edit mb-1"><i style="font-size: 20px; font-weight: bold;" class="fas fa-pencil-alt"></i></a>'+
                ...
                columnDefs: [
                    {
                        targets: -1,
                        render: function(data, type, row, meta){
                            return '<a href="javascript:void(0)" id="show" data-url="/admin/enterprise/edit_cargo/' + row.id + '" class="btn btn-outline-success show-cargo-modal-edit mb-1"><i style="font-size: 20px; font-weight: bold;" class="fas fa-pencil-alt"></i></a>'+
                ...
                columnDefs: [
                    {
                        targets: -1,
                        render: function(data, type, row, meta){
                            return '<a href="javascript:void(0)" id="show" data-url="/admin/enterprise/edit_area/' + row.id + '" class="btn btn-outline-success show-area-modal-edit mb-1"><i style="font-size: 20px; font-weight: bold;" class="fas fa-pencil-alt"></i></a>'+
